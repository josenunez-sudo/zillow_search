...
from ui.tours_tab import render_tours_tab  # <-- add
...
tab_run, tab_clients, tab_tours = st.tabs(["Run", "Clients", "Tours"])  # <-- add Tours tab
...
with tab_tours:
    render_tours_tab(state=st.session_state)  # <-- call it
