...
# ---------- bring in client helpers used by Run tab ----------
# These are defined in ui/clients_tab.py. We import safely so this file can still load
# even if Supabase isn't configured (the shims keep UI responsive).
try:
