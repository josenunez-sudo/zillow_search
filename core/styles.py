...
.badge.new {
  ...
  color:#065f46; border:1px solid rgba(5,150,105,.35);
...
html[data-theme="dark"] .iconbar .stButton > button { background:#0f172a; color:#cbd5e1; border-color:rgba(255,255,255,.08); }
.iconbar .stButton > button:hover { transform: translateY(-1px); }
.iconbar .stButton > button:active { transform: translateY(0) scale(.98); }

/* Inline edit/confirm panels */
.inline-panel { margin-top:6px; padding:6px; border:1px dashed var(--row-border); border-radius:8px; background:rgba(148,163,184,.08); }

/* ====== DATE/TIME CHIPS (with !important to survive inline component styles) ====== */
.stApp .chip {
  display:inline-block !important;
  font-weight:800 !important; font-size:12px !important; line-height:1 !important;
  padding:4px 10px !important; border-radius:999px !important; border:1px solid transparent !important;
...
.stApp .chip-date {
  ...
  color:#7f1d1d !important; border-color: rgba(127,29,29,.35) !important;
  box-shadow: 0 2px 6px rgba(127,29,29,.15) !important;
}
.stApp .chip-time {
  background: linear-gradient(180deg, #e0e7ff 0%, #c7d2fe 100%) !important;
  color:#1e3a8a !important; border-color: rgba(30,58,138,.35) !important;
  box-shadow: 0 2px 6px rgba(30,58,138,.15) !important;
}
/* Dark theme */
html[data-theme="dark"] .chip-date, .stApp [data-theme="dark"] .chip-date {
  ...
  color:#fecaca !important; border-color: rgba(254,202,202,.35) !important;
  box-shadow: 0 2px 6px rgba(0,0,0,.35) !important;
}
html[data-theme="dark"] .chip-time, .stApp [data-theme="dark"] .chip-time {
  background: linear-gradient(180deg, #312e81 0%, #1e3a8a 100%) !important;
  color:#c7d2fe !important; border-color: rgba(199,210,254,.35) !important;
  box-shadow: 0 2px 6px rgba(0,0,0,.35) !important;
}
</style>
